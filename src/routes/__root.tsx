...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "PrepPilot — AI Interview Readiness Analyzer" },
      {
        name: "description",
        content:
          "Practice mock interviews with an AI interviewer, get scored across real competencies, analyze your resume, and follow a personalized roadmap to job-ready.",
      },
      { name: "author", content: "PrepPilot" },
      { property: "og:title", content: "PrepPilot — AI Interview Readiness Analyzer" },
      {
        property: "og:description",
        content: "AI mock interviews, resume analysis, and a personalized path to interview-ready.",
      },
